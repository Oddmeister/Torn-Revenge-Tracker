      ...
      data.forEach(r => {
        ...
        panel.innerHTML += `
          <div style="margin-bottom:8px;">
            ...
            <div style="text-align:right;">${attackBtn}${bountyBtn}<button data-id="${r.id}" class="btn-ignore" style="background:none;border:none;color:#f88;cursor:pointer;font-size:11px;">✕</button></div>
          </div>
        `;
      });
    }
